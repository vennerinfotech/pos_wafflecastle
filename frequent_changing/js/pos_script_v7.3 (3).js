(function ($) {
    ...
    function call_print_invoice(order_info, sale_id, sale_inv_no = '', inv_no = '') {
        ...
        invoice_print += ` <tr>
                                        <th  class="text_left"><h4><b>Total</b></h4>                                        
                                        </th>
                                            <th class="text-right"><h4><b>
                                                `+ getAmount(order.total_payable) + `</b></h4>
                                            </th>
                                        </tr></tbody></table>`;
...
// <td style="text-align:left"><h5 style="margin-bottom: 0px; margin-top: 0px;"><b>` + order.sale_no + (sale_inv_no ? ' - ' + sale_inv_no : main_sale_inv_no ) + `</b></h5></td>