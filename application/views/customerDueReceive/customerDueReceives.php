...
<section class="content-header px-0">
    <div class="row">
        <div class="col-md-6">
            ...
            <input type="hidden" class="datatable_name" data-title="<?php echo lang('customer_due_receives'); ?>" data-id_name="datatable" data-sumColumns= '<?php echo json_encode([4]); ?>'>
        </div>
        <div class="col-md-6">
