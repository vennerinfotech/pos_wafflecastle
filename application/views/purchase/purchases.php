        ...
        <div class="table-box">
                 ...
                 <div class="table-responsive">
                     <table id="datatable" class="table table-responsive">
                         ...
                         <tbody>
                             <?php
                             $grand_total = $paid_total = $due_total = 0;
                            ...
                            foreach ($purchases as $prchs) {
                             ...
                             <tr>
                                 ...
                                 <?php $grand_total += escape_output(getAmtP($prchs->grand_total)); ?>
                                 <td><?php echo escape_output(getAmtPCustom($prchs->paid)) ?></td>
                                 <?php $paid_total += escape_output(getAmtP($prchs->paid)); ?>
                                 <td><?php echo escape_output(getAmtPCustom($prchs->due)) ?></td>
                                 <?php $due_total += escape_output(getAmtP($prchs->due)); ?>
