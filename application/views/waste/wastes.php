            ...
            <section class="content-header">
                <div class="row">
                    <div class="col-sm-12 col-md-8">
                        ...
                        <input type="hidden" class="datatable_name" data-title="<?php echo lang('wastes'); ?>" data-id_name="datatable" data-sumColumns= '<?php echo json_encode([3]); ?>'>
                    </div>
                        ...
                        <table id="datatable" class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <?php $sum += getAmtPCustom($wsts->total_loss);  ?>
