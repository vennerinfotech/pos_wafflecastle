        ...
        <section class="content-header">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input type="hidden" class="datatable_name" data-title="<?php echo lang('expenses'); ?>" data-id_name="datatable" data-sumColumns= '<?php echo json_encode([3]); ?>'>
                </div>
                <div class="col-md-6">
