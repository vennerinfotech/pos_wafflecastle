...
<section class="main-content-wrapper">
    ...
    <section class="content-header">
        ...
        <input type="hidden" class="datatable_name" data-title="<?php echo lang('vat_report'); ?>" data-id_name="datatable"  data-sumColumns= '<?php echo json_encode([3,5]); ?>'>
    </section>
                    ...
                    <table id="datatable" class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo escape_output(getAmtFmt($value->total_vat)) ?></td>
                            </tr>
                            <?php
                                endif;
                                }
