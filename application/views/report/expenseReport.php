...
<section class="main-content-wrapper">
    ...
    <section class="content-header">
        ...
        <input type="hidden" class="datatable_name" data-title="<?php echo lang('expense_report'); ?>" data-id_name="datatable"  data-sumColumns= '<?php echo json_encode([2]); ?>'>
    </section>
                    ...
                    <table id="datatable" class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo escape_output(getAmtFmt($value->amount)) ?></td>
                        ...
                        <?php if (!empty($expenseReport)): ?>
                            <tr>
                                <td></td>
                                <th>Total Sum</th>
                                <th><?php echo escape_output(getAmtCustom($sum)); ?></th>
                                <th></th>
                            </tr>
                            <tfoot>
                                <tr>
