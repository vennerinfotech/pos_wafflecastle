...
<section class="main-content-wrapper">
    <section class="content-header">
        ...
        ?>
        <input type="hidden" class="datatable_name" data-title="<?php echo lang('customer_due_report'); ?>" data-id_name="datatable" data-sumColumns= '<?php echo json_encode([2]); ?>'>
    </div>
    </section>
                    ...
                    <table id="datatable" class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo escape_output(getAmtFmt($total_due)) ?></td>
                        ...
                        <?php if (isset($customers)): ?>
                            <tr>
                                ...
                                <th><?php echo escape_output(getAmtCustom($pGrandTotal)); ?>
                            </th>
                            <tfoot>
                                <tr>
                                    <th class="ir_txt_center"></th>
