...
<section class="main-content-wrapper">
    ...
    <section class="content-header">
        <input type="hidden" class="datatable_name" data-title="<?php echo lang('food_sales_report'); ?>" data-id_name="datatable"  data-sumColumns= '<?php echo json_encode([4,5,6]); ?>'>
                    ...
                    <table id="datatable" class="table">
                        ...
                        <?php if (!empty($foodMenuSales)): ?>
                            ...
                            <tr>
                                ...
                                <th></th>
                                <th></th>
                                <th>Sum(<?php echo lang('Amount_X_Qty'); ?>)</th>
                                <th></th>
                                <th></th>
                                <th></th>
                            </tr>
