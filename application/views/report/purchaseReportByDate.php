...
<section class="main-content-wrapper">
    <section class="content-header">
        ...
        <input type="hidden" class="datatable_name" data-id_name="datatable" data-sumColumns= '<?php echo json_encode([4,5,6]); ?>' >
    </section>
                        ...
                        <table id="datatable" class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo escape_output(getAmtFmt($value->grand_total)) ?></td>
                                ...
                                <?php if (isset($purchaseReportByDate)): ?>
                                    <tfoot>
                                        <tr>
                                            <td colspan="3"></td>
                                            <td class="ir_txt_right">Sum</td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
