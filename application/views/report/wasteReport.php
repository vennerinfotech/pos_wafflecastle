...
<section class="main-content-wrapper">
    ...
    <section class="content-header">
        ...
        <input type="hidden" class="datatable_name" data-title="<?php echo lang('waste_report'); ?>" data-id_name="datatable"  data-sumColumns= '<?php echo json_encode([3]); ?>'>
    </section>
                    ...
                    <table id="datatable" class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo escape_output(getAmtFmt($value->total_loss)) ?></td>
                                <?php $total_loss += escape_output(getAmtp($value->total_loss));  ?>
                        ...
                        <?php if (!empty($wasteReport)): ?>
                            <tr>
                                <td colspan="2"></td>
                                <th>Total</th>
                                <th><?php echo number_format($total_loss,2); ?></th>
                            </tr>
                            <tfoot>
                                <tr>
                                    <td></td>
