...
<section class="main-content-wrapper">
    ...
    <section class="content-header">
        ...
        <input type="hidden" class="datatable_name" data-id_name="datatable"  data-sumColumns= '<?php echo json_encode([2,3]); ?>'>
    </section>
                    ...
                    <table id="datatable" class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo escape_output(getAmtFmt($value->total_refund)) ?></td>
                                <?php $total_refund += $value->total_refund;?>
                            </tr>
                            <?php
                                }
                            endif;
                        ...
                        <?php if (isset($saleReportByDate)): ?>
                            <tr>
                                <th class="ir_txt_center"></th>
                                <th><?php echo lang('total'); ?></th>
                                <th><?php echo escape_output(getAmtCustom($total_payable)); ?></th>
                                <th> <?php echo escape_output(getAmtCustom($total_refund)); ?></th>
                            </tr>
                            <tfoot>
                                <tr>
                                    <th class="ir_txt_center"></th>
