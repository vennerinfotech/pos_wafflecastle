...
class Outlet extends Cl_Controller {
    ...
    public function setOutletSession($encrypted_id) {
        ...
        if (!empty($outlet_details->tax_registration_no)) {
	...
	public function fetchWaiters(int $company_id)
    {
        $waiters = $this->Sale_model->getWaitersForThisCompany($company_id, 'tbl_users');
